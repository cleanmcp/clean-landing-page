      ...
      >
        ...
        <div className="mb-10 text-center">
          ...
          <h1
            ...
            style={{ fontFamily: "var(--font-jakarta)" }}
          >
            Welcome <em className="not-italic" style={{ fontFamily: "var(--font-display)" }}>back</em>
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="mb-2 flex items-center justify-between">
                <label htmlFor="password" className="text-sm font-medium text-white/60" style={{ fontFamily: "var(--font-jakarta)" }}>
                  Password
                </label>
                <Link
                  href="/forgot-password"
                  className="text-xs font-medium text-[#79c0ff]/70 transition-colors duration-200 hover:text-[#79c0ff]"
                  style={{ fontFamily: "var(--font-jakarta)" }}
                >
                  Forgot password?
                </Link>

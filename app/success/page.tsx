    ...
    <div className="relative min-h-screen overflow-hidden bg-[var(--cream)]">
      ...
      <section className="flex min-h-screen items-center justify-center px-5 pt-24 pb-16 sm:px-6">
        ...
        >
          ...
          <motion.div
            className="mb-8 inline-flex items-center gap-2 rounded-full border border-[var(--cream-dark)] bg-white px-4 py-2 shadow-sm"
          ...
          {/* Heading */}
          <motion.h1
            className="mb-6 text-4xl font-normal leading-[1.1] tracking-tight text-[var(--ink)] sm:text-5xl lg:text-6xl"
          ...
          {/* Subtext */}
          <motion.p
            className="mb-10 text-lg leading-relaxed text-[var(--ink-light)]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}

...
export const organizations = pgTable(
  "organizations",
  {
    ...
    creditGrantMonthly: integer("credit_grant_monthly").notNull().default(0),
    creditPeriodStart: timestamp("credit_period_start"),
    creditPeriodEnd: timestamp("credit_period_end"),
...
export const githubInstallations = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("github_installations_org_account_uniq").on(table.orgId, table.accountLogin),
  ]
);

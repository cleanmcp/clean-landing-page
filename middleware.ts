...
export const config = {
  matcher: [
    ...
    "/((?!_next|api/webhooks|api/cli|api/waitlist|api/stripe/webhook|api/internal|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)",
  ],
};
